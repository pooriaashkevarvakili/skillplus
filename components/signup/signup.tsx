...
export default function Signup() {
    ...
    return (
        <div>
            ...
            <div dir="rtl" className="flex flex-col gap-y-3 mt-3 items-center justify-center">
                ...
                <TextInput value={email}
                    ...
                    className=" w-[400px]" id="email1" type="email" placeholder="ایمیل" name="email" required />

                <div
                    onClick={handleToggle}
                    className="absolute top-[13.7rem] right-[51rem] transition duration-300 ease-in z-50 flex items-center ps-3.5 cursor-pointer"
                >
                    {isStarMode ? (
                        <svg
                ...
                <TextInput value={password}
                    ...
                    className="  w-[400px]" placeholder="کلمه عبور" id="password1" style={{
                        backgroundColor: "#eee",
                        border: "none",
                        borderRadius: "8.078px",
                ...
                <TextInput
                    ...
                    className=" w-[400px]" id="name1" name="name" type="text" placeholder="نام" required />
                ...
                <TextInput
                    ...
                    className=" w-[400px]" id="name1" name="name" type="text" placeholder="نام خانوادگی" required />
                <TextInput
                    value={username}
                    onChange={(e) => {
                    ...
                    className=" w-[400px]" id="name1" name="name" type="text" placeholder="نام کاربری" required />
                <TextInput
                    value={mobile}
                    onChange={(e) => {
                    ...
                    className=" w-[400px]" placeholder="شماره موبایل" id="mobile1" type="number" required name="mobile" />

            </div>


            <div className="flex items-center mt-4 justify-center">
                <button onClick={setlogin} className="w-[400px] text-white bg-[#EE2556] h-[50px] text-xl yekan-bold rounded-xl  mt-4" type="submit">ثبت نام</button>
